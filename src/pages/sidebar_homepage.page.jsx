    ...
    <div className="min-w-[25%]  lg:min-w-[400ox] max-w-min border-l border-grey pl-8 pt-3 max-md:hidden">
      <div className="flex mb-6 border border-gray-400 focus-within:border-yellow-500 rounded-lg overflow-hidden group">
        <input
          type="text"
          placeholder="Search..."
          className="bg-[#b4e7ad] px-3 py-2 w-full transition-all duration-300 focus:w-[95%] focus:outline-none placeholder-black"
          onKeyDown={handleSearch}
        />
        <button
          className="bg-[#519e50] text-black px-4 py-2 flex items-center justify-between w-[120px]
            transition-all duration-300 group-focus-within:w-10 group-focus-within:justify-center
            group-focus-within:bg-[#3e7e3e] hover:bg-[#3e7e3e] gap-x-2 md:w-4/8 rounded-md"
      ...
      {/* About Me Section */}
      <div className="bg-[#b4e7ad] relative w-full max-w-lg mx-auto ">
        {/* Hộp chứa tiêu đề với nền xám */}
        <div
          className="bg-[b4e7ad] w-full py-3 px-6 inline-block relative mb-4 text-center"
          style={{ backgroundColor: "#519e50" }} // Màu xám nhạt
        >
          <span
          ...
          <div
            ...
            style={{
              ...
              borderTop: "8px solid #519e50", // Màu xám nhạt giống phần trên
            }}
          ></div>
        </div>
        {aboutMeBlog && (
